...
class GeonetnzVolcanoFeedEntityManager:
    ...
    async def _generate_entity(self, external_id):
        """Generate new entity."""
        _LOGGER.debug("inside dispatcher send method...............!!!!!!!!!!!!!!!!")
        _LOGGER.debug(async_dispatcher_send(
            self._hass,
    ...
    async def _update_entity(self, external_id):
        """Update entity."""
        _LOGGER.debug("inside _update_entity method...@#@#@#@#@#")
        _LOGGER.debug(async_dispatcher_send(self._hass, SIGNAL_UPDATE_ENTITY.format(external_id)))
